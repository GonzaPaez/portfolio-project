...
# Usa una fecha de prueba del 1 de abril del 2024 para la fecha minima del ultimo cambio.
test_date = date(2024,4,1)

@pytest.fixture(scope="function")
def db_session():
    """Tis starts a database session and closes it when done"""
...
def test_get_players(db_session):
    """Tests that the count of players in th database is what is expected"""
    players = crud.get_players(
        db_session, skip=0, limit=10000,
